...
function run(input_user) {
    ...
    /* here it returns false if the entry is different in length from 11 digits (CPF) and 14 digits (CNPJ)*/
    else {
        return false;
    }
 }
